...
public sealed class DemoBalanceConfig : ScriptableObject
{
    ...
    [Min(0f)] public float firstEmergencyLockSeconds = 60f;
    ...
    [Min(0f)] public float emergencyCooldownSeconds = 60f;

    [Header("Kill and task economy")]
    [Min(0f)] public float baseKillCooldownSeconds = 30f;
    ...
    public static float FirstEmergencyLockSeconds => Runtime != null ? Mathf.Max(0f, Runtime.firstEmergencyLockSeconds) : 60f;
    ...
    public static float EmergencyCooldownSeconds => Runtime != null ? Mathf.Max(0f, Runtime.emergencyCooldownSeconds) : 60f;
    public static float BaseKillCooldownSeconds => Runtime != null ? Mathf.Max(0f, Runtime.baseKillCooldownSeconds) : 30f;
